...
import 'package:haraj/ui/app_info/app_tax.dart';
import 'package:haraj/ui/app_loading/app_loading_view.dart';
import 'package:haraj/ui/blog/detail/blog_view.dart';
import 'package:haraj/ui/blog/list/blog_list_container.dart';
import 'package:haraj/ui/chat/detail/chat_view.dart';
import 'package:haraj/ui/chat/image/chat_image_detail_view.dart';
import 'package:haraj/ui/dashboard/core/dashboard_view.dart';
import 'package:haraj/ui/force_update/force_update_view.dart';
import 'package:haraj/ui/gallery/detail/gallery_view.dart';
import 'package:haraj/ui/gallery/grid/gallery_grid_view.dart';
import 'package:haraj/ui/history/list/history_list_container.dart';
import 'package:haraj/ui/intro/intro.dart';
import 'package:haraj/ui/item/condition/item_condition_view.dart';
import 'package:haraj/ui/item/currency/item_currency_view.dart';
import 'package:haraj/ui/item/deal_option/item_deal_option_view.dart';
import 'package:haraj/ui/item/detail/product_detail_view.dart';
import 'package:haraj/ui/item/entry/custom_camera_view.dart';
import 'package:haraj/ui/item/entry/item_entry_container.dart';
import 'package:haraj/ui/item/favourite/favourite_product_list_container.dart';
import 'package:haraj/ui/item/item/user_item_follower_list_view.dart';
import 'package:haraj/ui/item/item/user_item_list_for_profile_view.dart';
import 'package:haraj/ui/item/item/user_item_list_view.dart';
import 'package:haraj/ui/item/item_build_type/item_build_type_list_view.dart';
import 'package:haraj/ui/item/item_color/item_color_list_view.dart';
import 'package:haraj/ui/item/item_fuel_type/item_fuel_type_list_view.dart';
import 'package:haraj/ui/item/item_location/item_entry_location_view.dart';
import 'package:haraj/ui/item/item_seller_type/item_seller_type_list_view.dart';
import 'package:haraj/ui/item/list_with_filter/filter/category/filter_list_view.dart';
import 'package:haraj/ui/item/list_with_filter/filter/filter/item_search_view.dart';
import 'package:haraj/ui/item/list_with_filter/product_list_with_filter_container.dart';
import 'package:haraj/ui/item/paid_ad/paid_ad_item_list_container.dart';
import 'package:haraj/ui/item/paid_ad_product/paid_ad_product_list_container.dart';
import 'package:haraj/ui/item/price_type/item_price_type_view.dart';
import 'package:haraj/ui/item/promote/CreditCardView.dart';
import 'package:haraj/ui/item/promote/InAppPurchaseView.dart';
import 'package:haraj/ui/item/promote/ItemPromoteView.dart';
import 'package:haraj/ui/item/promote/choose_payment_view.dart';
import 'package:haraj/ui/item/promote/pay_stack_view.dart';
import 'package:haraj/ui/item/reported_item/reported_item_container_view.dart';
import 'package:haraj/ui/item/transmission/transmission_list_view.dart';
import 'package:haraj/ui/item/type/type_list_view.dart';
import 'package:haraj/ui/language/list/language_list_view.dart';
import 'package:haraj/ui/location/filter_location_view.dart';
import 'package:haraj/ui/location/item_location_container.dart';
import 'package:haraj/ui/manufacturer/filter_list/manufacturer_filter_list_view.dart';
import 'package:haraj/ui/manufacturer/list/manufacturer_list_container.dart';
import 'package:haraj/ui/map/map_filter_view.dart';
import 'package:haraj/ui/map/map_pin_view.dart';
import 'package:haraj/ui/model/filter/sub_category_search_list_view.dart';
import 'package:haraj/ui/model/list/model_grid_view.dart';
import 'package:haraj/ui/noti/detail/noti_view.dart';
import 'package:haraj/ui/noti/list/noti_list_view.dart';
import 'package:haraj/ui/noti/notification_setting/notification_setting_view.dart';
import 'package:haraj/ui/offer/list/offer_container_view.dart';
import 'package:haraj/ui/offline_payment/offline_payment_view.dart';
import 'package:haraj/ui/rating/list/rating_list_view.dart';
import 'package:haraj/ui/safety_tips/safety_tips_view.dart';
import 'package:haraj/ui/setting/camera/camera_setting_view.dart';
import 'package:haraj/ui/setting/setting_container_view.dart';
import 'package:haraj/ui/setting/setting_privacy_policy_view.dart';
import 'package:haraj/ui/user/blocked_user/block_user_container_view.dart';
import 'package:haraj/ui/user/edit_profile/edit_profile_view.dart';
import 'package:haraj/ui/user/forgot_password/forgot_password_container_view.dart';
import 'package:haraj/ui/user/list/follower_user_list_view.dart';
import 'package:haraj/ui/user/list/following_user_list_view.dart';
import 'package:haraj/ui/user/more/more_container_view.dart';
import 'package:haraj/ui/user/password_update/change_password_view.dart';
import 'package:haraj/ui/user/phone/register/phone_register_container_view.dart';
import 'package:haraj/ui/user/phone/sign_in/phone_sign_in_container_view.dart';
import 'package:haraj/ui/user/phone/verify_phone/verify_phone_container_view.dart';
import 'package:haraj/ui/user/register/register_container_view.dart';
import 'package:haraj/ui/user/user_detail/user_detail_view.dart';
import 'package:haraj/ui/user/verify/verify_email_container_view.dart';
...
import 'package:haraj/viewobject/holder/location_parameter_holder.dart';
import 'package:haraj/viewobject/holder/paid_history_holder.dart';
import 'package:haraj/viewobject/holder/paystack_intent_holder.dart';
import 'package:haraj/viewobject/holder/product_parameter_holder.dart';
import 'package:haraj/viewobject/manufacturer.dart';
import 'package:haraj/viewobject/message.dart';
...
import 'package:haraj/viewobject/ps_app_version.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case '${RoutePaths.intro}':
      ...
      return MaterialPageRoute<dynamic>(
          settings: const RouteSettings(name: RoutePaths.intro),
          builder: (BuildContext context) {
            return IntroView();
          });
...
/*    case '${RoutePaths.login_container}':
    ...
    case '${RoutePaths.user_phone_register_container}':
      return MaterialPageRoute<dynamic>(
          builder: (BuildContext context) => PhoneRegisterContainerView());
    ...
    case '${RoutePaths.apptax}':
      return MaterialPageRoute<dynamic>(
          builder: (BuildContext context) => AppTaxView());
    ...
    case '${RoutePaths.productDetail}':
      ...
      return MaterialPageRoute<dynamic>(
          ...
          builder: (BuildContext context) {
            return ProductDetailView(
              productTitle: holder.productTitle,
              productId: holder.productId,
              heroTagImage: holder.heroTagImage,
              heroTagTitle: holder.heroTagTitle,
            );
