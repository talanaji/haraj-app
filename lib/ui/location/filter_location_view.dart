    ...
    return WillPopScope(
        ...
        child: PsWidgetWithAppBarWithNoProvider(
          ...
          child: Column(children: <Widget>[
            PsTextFieldWidget(
                titleText: Utils.getString(context, 'filter_location__name_title'),
                hintText: Utils.getString(context, 'filter_location__name_title'),
                textAboutMe: false,
                textEditingController: userNameController),
            const SizedBox(
            ...
            Row(
              children: <Widget>[
                ...
                Text(Utils.getString(context, 'filter_location__ordering_title'),
