...
class ProductVeticalListItemForSearch extends StatefulWidget {
  const ProductVeticalListItemForSearch(
      {Key key,
  ...
  @override
  _ProductVeticalListItemForSearchView createState() =>
      _ProductVeticalListItemForSearchView();
}

class _ProductVeticalListItemForSearchView
    extends State<ProductVeticalListItemForSearch>
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Row(
                              children: [
                                Icon(PsColors.location, color: PsColors.mainColor,size: 16,),
                                Padding(padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width * .01,0,0,0)),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Icon(PsColors.group__2,color: PsColors.mainColor,size: 20),
                                Padding(padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width * .01,0,0,0)),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Icon(FlutterIcons.tag_outline_mco,color: PsColors.mainColor,size: 20),
                                Padding(padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width * .01,0,0,0)),
                                Text(widget.product.manufacturer.name, style: TextStyle(fontSize: 12)
                                  ,overflow: TextOverflow.ellipsis,
                                ),
                              ],
                            ),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Icon(PsColors.messages_icon,color: PsColors.mainColor,size: 20),
                                Padding(padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width * .01,0,0,0)),
