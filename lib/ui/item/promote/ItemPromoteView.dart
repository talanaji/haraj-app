...
import 'package:haraj/provider/promotion/item_promotion_provider.dart';
import 'package:haraj/provider/token/token_provider.dart';
...
import 'package:haraj/viewobject/holder/item_paid_history_parameter_holder.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final Widget razorButtonWidget = Container(
      ...
      child: PSButtonWithIconWidget(
          ...
          width: double.infinity,
          colorData: PsColors.paypalColor,
          titleText: Utils.getString(context, 'checkout__razor'),
          onPressed: () async {
            if (double.parse(amount) <= 0) {
              return;
            }
