...
import 'package:haraj/ui/common/base/ps_widget_with_appbar_with_no_provider.dart';
...
import 'package:haraj/ui/common/ps_credit_card_form_for_pay_stack.dart';
...
class PayStackViewState extends State<PayStackView> {
  ...
  @override
  void initState() {
    PaystackPlugin.initialize(publicKey: 'pk_test_ea5593678cc80271640f1929b5a63ac830dd66f8');//widget.payStackKey);
    super.initState();
  }
