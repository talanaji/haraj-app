...
class ItemSellerTypeListItem extends StatelessWidget {
  const ItemSellerTypeListItem(
      {Key key,
      @required this.itemSellerType,
  ...
  final ItemSellerType itemSellerType;
    ...
    return AnimatedBuilder(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Ink(
            color: selectedName == itemSellerType.sellerType
                ? Colors.green[200]
                : PsColors.backgroundColor,
            child: Padding(
              padding: const EdgeInsets.all(PsDimens.space16),
              child: Text(
                itemSellerType.sellerType,
