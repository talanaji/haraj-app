...
import 'package:haraj/provider/user/user_list_provider.dart';
import 'package:haraj/repository/user_repository.dart';
import 'package:haraj/ui/common/base/ps_widget_with_appbar.dart';
import 'package:haraj/ui/user/list/user_vertical_list_item.dart';
      ...
      child: PsWidgetWithAppBar<UserListProvider>(
          ...
          builder:
            ...
            return Stack(children: <Widget>[
                                ...
                                if (provider.userList.data != null ||
                                  ...
                                  return UserVerticalListItem(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (returnData != null &&
                                          returnData is bool) {
                                        provider.loadUserList(provider
                                            .followingUserParameterHolder);
                                      }
                                    },
                                  );
                                } else {
              ...
              PSProgressIndicator(
                provider.userList.status,
                message: provider.userList.message,
              )
            ]);
          }),
    );
