...
import 'package:haraj/viewobject/holder/phone_login_parameter_holder.dart';
import 'package:haraj/viewobject/holder/resend_code_holder.dart';
            ...
            onPressed: () async {
              if (codeController.text.isEmpty) {
                ...
                //user.auth().getUserByPhoneNumber(phone)
                 // fb_auth.FirebaseAuth.g
                  if (user != null) {
                    print('correct code register ');
                    await gotoProfile(
                        context,
                        user.uid,
                        widget.userName,
                    ...
                    try {
                      await fb_auth.FirebaseAuth.instance
                        ...
                        if (user != null) {
                          print('correct code again login');
                          await gotoProfile(
                              context,
                              user.user.uid,
                              widget.userName,
