...
import 'package:haraj/provider/offline_payment/offline_payment_method_provider.dart';
...
import 'package:haraj/ui/offline_payment/offline_payment_item.dart';
    ...
    return WillPopScope(
      ...
      child: PsWidgetWithAppBar<OfflinePaymentMethodProvider>(
          ...
          builder: (BuildContext context, OfflinePaymentMethodProvider provider,
              Widget child) {
            if (provider != null &&
                provider.offlinePaymentMethod != null &&
              ...
              return Stack(children: <Widget>[
                ...
                PSProgressIndicator(
                  provider.offlinePaymentMethod.status,
                  message: provider.offlinePaymentMethod.message,
                ),
                Positioned(
                    bottom: 5,
                    right: 5,
