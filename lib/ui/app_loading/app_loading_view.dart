...
import 'package:haraj/provider/clear_all/clear_all_data_provider.dart';
import 'package:haraj/repository/clear_all_data_repository.dart';
import 'package:haraj/ui/common/dialog/version_update_dialog.dart';
import 'package:haraj/ui/common/dialog/warning_dialog_view.dart';
import 'package:haraj/ui/common/ps_square_progress_widget.dart';
      ...
      if (_psAppInfo.status == PsStatus.SUCCESS) {
        ...
        //if (provider.psValueHolder.locationId != null) {
          ...
          if (_seen) {
            ...
            Navigator.pushReplacementNamed(
              context,
              RoutePaths.intro,//RoutePaths.home,
            );
          }
        /*} else {
          Navigator.pushReplacementNamed(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Text(
                        Utils.getString(context, 'app_welcome'),
