...
import 'package:haraj/viewobject/holder/noti_parameter_holder.dart';
...
import 'package:haraj/viewobject/category.dart';
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Stack(children: <Widget>[
                    ...
                    PSProgressIndicator(
                      provider.notiList.status,
                      message: provider.notiList.message,
                    )
                  ]),
                )
              ],
