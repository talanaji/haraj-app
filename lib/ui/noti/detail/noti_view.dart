...
import 'package:haraj/provider/noti/noti_provider.dart';
...
import 'package:haraj/viewobject/holder/noti_post_parameter_holder.dart';
...
class _NotiViewState extends State<NotiView>
  ...
  Widget build(BuildContext context) {
    ...
    print(
        '............................Build UI Again ............................');
    return WillPopScope(
        onWillPop: _requestPop,//() async => false, //_onWillPop,
        ...
        child: PsWidgetWithAppBar<NotiProvider>(
            ...
            builder:
              ...
              if (widget.noti != null) {
                print(widget.noti.defaultPhoto.imgPath);
                return SingleChildScrollView(
                    scrollDirection: Axis.vertical,
                    child: Column(children: <Widget>[
                      (widget.noti.defaultPhoto.imgPath !="")?
                      Container(
