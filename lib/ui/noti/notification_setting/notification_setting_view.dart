...
import 'package:haraj/viewobject/holder/noti_register_holder.dart';
import 'package:haraj/viewobject/holder/noti_unregister_holder.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        ...
        if (PsConfig.isShowTokenId) _TokenIdWidget() else Container()
      ],
    );
  }
}
