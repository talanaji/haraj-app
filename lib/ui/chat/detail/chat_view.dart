...
import 'package:haraj/provider/chat/chat_history_list_provider.dart';
import 'package:haraj/provider/chat/get_chat_history_provider.dart';
...
import 'package:haraj/ui/chat/dialog/chat_make_offer_dialog.dart';
...
import 'package:haraj/ui/rating/entry/rating_input_dialog.dart';
import 'package:haraj/utils/ps_progress_dialog.dart';
import 'package:haraj/utils/utils.dart';
import 'package:haraj/viewobject/chat.dart';
import 'package:haraj/viewobject/chat_history.dart';
import 'package:haraj/viewobject/chat_user_presence.dart';
import 'package:haraj/viewobject/common/ps_value_holder.dart';
import 'package:haraj/viewobject/default_photo.dart';
import 'package:haraj/viewobject/holder/chat_noti_parameter_holder.dart';
import 'package:haraj/viewobject/holder/get_chat_history_parameter_holder.dart';
import 'package:haraj/viewobject/holder/intent_holder/product_detail_intent_holder.dart';
import 'package:haraj/viewobject/holder/make_mark_as_sold_parameter_holder.dart';
import 'package:haraj/viewobject/holder/make_offer_parameter_holder.dart';
import 'package:haraj/viewobject/holder/reset_unread_message_parameter_holder.dart';
import 'package:haraj/viewobject/holder/sync_chat_history_parameter_holder.dart';
import 'package:haraj/viewobject/holder/update_chat_date_parameter_holder.dart';
...
class _ChatViewState extends State<ChatView>
  ...
  print(PsConfig.androidDatabaseUrl);
  ...
  Future<void> _insertDataToFireBase(
    ...
    UpdateChatDateParameterHolder updateChatDateParameterHolder;
    if (widget.chatFlag == PsConst.CHAT_FROM_BUYER) {
      ...
      getChatHistoryProvider.postUpdateChatDate(
          updateChatDateParameterHolder.toMap(), psValueHolder.loginUserId);
    }
    else
      {
        updateChatDateParameterHolder = UpdateChatDateParameterHolder(
    ...
    if (widget.psValueHolder.loginUserId == widget.messageObj.sendByUserId) {
      ...
      if (widget.messageObj.type == PsConst.CHAT_TYPE_TEXT) {
        ...
        return _ChatImageSenderWidget(
            widget: widget, deleteDataToFireBase: widget.deleteDataToFireBase);
      } else {
        return Container();
      }
    } else {
    ...
    final Widget _imageWidget = PsNetworkImage(
      ...
      onTap: () {
        final ProductDetailIntentHolder holder = ProductDetailIntentHolder(
          productTitle: widget.itemData.title,
                      ...
                      children: <Widget>[
                        Text(
                          widget.itemData != null &&
                              ...
                              ? '${Utils.getPriceFormat(widget.itemData.price)}  ر.س. '
                              : Utils.getString(context, 'item_price_free'),
                          style: Theme.of(context).textTheme.bodyText1,
                        ),
