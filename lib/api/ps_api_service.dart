...
import 'package:haraj/viewobject/blocked_user.dart';
import 'package:haraj/viewobject/bunner.dart';
import 'package:haraj/viewobject/chat_history.dart';
import 'package:haraj/viewobject/condition_of_item.dart';
import 'package:haraj/viewobject/deal_option.dart';
...
import 'package:haraj/viewobject/item_paid_history.dart';
...
import 'package:haraj/viewobject/offer.dart';
import 'package:haraj/viewobject/offline_payment_method.dart';
import 'package:haraj/viewobject/paid_ad_item.dart';
import 'package:haraj/viewobject/reported_item.dart';
import 'package:haraj/viewobject/shipping_cost.dart';
import 'package:haraj/viewobject/shipping_method.dart';
...
import 'package:haraj/viewobject/coupon_discount.dart';
...
import 'package:haraj/viewobject/rating.dart';
import 'package:haraj/viewobject/shipping_city.dart';
import 'package:haraj/viewobject/shipping_country.dart';
import 'package:haraj/viewobject/transmission.dart';
import 'package:haraj/viewobject/user.dart';
import 'package:haraj/viewobject/user_unread_message.dart';
...
*/
  ...
  Future<PsResource<List<Blog>>> getBlogList(int limit, int offset, String itemid) async {
    final String url =
        '${PsUrl.ps_item_comments_url}/api_key/${PsConfig.ps_api_key}/item_id/$itemid/limit/$limit/offset/$offset';
    print("${url}");
  ...
  /// Comment Entry
  ///
  Future<PsResource<Blog>> postCommentEntry(
      Map<dynamic, dynamic> jsonMap) async {
    const String url = '${PsUrl.ps_comment_entry_url}';
    return await postData<Blog, Blog>(Blog(), url, jsonMap);
  }
  ...
  ///
  /// ps_update_chat_date_url
  ///
  Future<PsResource<ChatHistory>> updateChatDate(
      Map<dynamic, dynamic> jsonMap ) async {
    print(jsonMap);
    final String url =
        '${PsUrl.ps_update_chat_date_url}';
