...
import 'package:haraj/viewobject/delete_object.dart';
import 'package:haraj/viewobject/ps_app_version.dart';
import 'package:haraj/viewobject/user_info.dart';
...
class PSAppInfo extends PsObject<PSAppInfo> {
  ...
  Map<String, dynamic> toMap(dynamic object) {
    if (object != null) {
      ...
      data['in_app_purchased_prd_id_android'] = object.inAppPurchasedPrdIdAndroid;
